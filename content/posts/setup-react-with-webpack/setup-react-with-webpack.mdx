...
You'll likely want to import CSS (or SASS). For that, check out my [other tutorial](/blog/basic-setup-for-a-web-application), or have a browse at some [webpack loaders](https://webpack.js.org/loaders/) on their site.