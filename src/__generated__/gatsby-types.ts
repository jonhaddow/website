...
enum FileFieldsEnum {
  ...
  childMarkdownRemark___frontmatter___abstract = 'childMarkdownRemark.frontmatter.abstract',
...
type SEOQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'author'>> }> };
